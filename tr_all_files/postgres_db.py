...
class TransactionDatabasePostgres(TransactionDatabase):
    ...
    def _save(self, transaction: Transaction) -> None:
        ...
        cur.execute("""
                ...
                balance_brutto = %s, balance_netto = %s, currency = %s WHERE id = %s;
        """, (transaction.source_account, transaction.target_account, transaction.balance_brutto, 
        ...
        if rows_count == 0:
            ...
            cur.execute("""
                    ...
                    balance_brutto, balance_netto, currency) VALUES (%s, %s, %s, %s, %s);
                    """, (str(transaction.id_), transaction.source_account, transaction.target_account,
                          transaction.balance_brutto, transaction.balance_netto, transaction.currency))
            self.conn.commit()
